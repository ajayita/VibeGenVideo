...
const App: React.FC = () => {
  ...
  const handleGenerate = async () => {
    ...
    try {
      const generatedText = await generateVideoPrompt(topic, vibestack, duration);
    ...
    <div className="min-h-screen transition-colors duration-300 bg-zinc-50 dark:bg-[#050505] text-zinc-900 dark:text-zinc-100 selection:bg-cine-accent selection:text-white pb-20">
      ...
      <main className="max-w-4xl mx-auto px-6 py-12">
        ...
        {loadingState === LoadingState.ERROR && (
          <div className="max-w-2xl mx-auto mt-8 p-4 bg-red-100 dark:bg-red-900/20 border border-red-200 dark:border-red-900/50 rounded-lg text-red-700 dark:text-red-200 text-center">
      ...
      <footer className="text-center text-zinc-400 dark:text-zinc-600 text-sm py-12 transition-colors duration-300">
